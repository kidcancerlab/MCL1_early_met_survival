...
Early (day 14) and Late (day 35) timepoints
...
DimPlot(tumor, reduction = "umap", pt.size = 1, label = T) + coord_fixed()

DimPlot(tumor, reduction = "umap", pt.size = 1, label = T, split.by = "group") + coord_fixed()
...
DimPlot(microenv, reduction = "umap", pt.size = 1, label = T) + coord_fixed()

DimPlot(microenv, reduction = "umap", pt.size = 1, label = T, split.by = "group") + coord_fixed()

# Save
save(tumor, file = "/gpfs0/home2/gdrobertslab/lab/Analysis/Emily/MCL1_early_met_survival/Data/tumor.RData")
save(microenv, file = "/gpfs0/home2/gdrobertslab/lab/Analysis/Emily/MCL1_early_met_survival/Data/microenv.RData")
```

```{r geneplots}
dot_plot <- DotPlot(tumor, features = c("BCL2", 
                            "BCL2L1",
                            "BCL2L2",
                            "BAD",
                            "BAX",
                            "MCL1"), group.by = "group", scale=F, cols = "Spectral") + RotatedAxis()

pdf("/gpfs0/home2/gdrobertslab/lab/Analysis/Emily/MCL1_early_met_survival/Figures/dot_plot.pdf",
    width = 7,
    height = 4)
dot_plot +
  coord_fixed() 
...
vln_plot <- VlnPlot(tumor, features = c("BCL2", 
                            "BCL2L1",
                            "BCL2L2",
                            "BAD",
                            "BAX",
                            "MCL1"), group.by = "group") + RotatedAxis()

pdf("/gpfs0/home2/gdrobertslab/lab/Analysis/Emily/MCL1_early_met_survival/Figures/vln_plot.pdf",
    width = 6,
    height = 5)
vln_plot 
dev.off()
...
feature_plot <- FeaturePlot(tumor, features = c("BCL2", 
                            "BCL2L1",
                            "BCL2L2",
                            "BAD",
                            "BAX",
                            "MCL1"), split.by = "group", order = T)

pdf("/gpfs0/home2/gdrobertslab/lab/Analysis/Emily/MCL1_early_met_survival/Figures/feature_plot.pdf",
    width = 6,
    height = 16)
feature_plot 
dev.off()
...
save(tumor_cc, file = "/gpfs0/home2/gdrobertslab/lab/Analysis/Emily/MCL1_early_met_survival/Data/tumor_cc.RData")
```
