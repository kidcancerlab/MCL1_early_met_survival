...
Idents(sender_sobj) <- "group"
Idents(receiver_sobj) <- "group"
Idents(sender_receiver_sobj) <- "group"
...
gset_stuff <- find_tar_genes(receiver_sobj,
                            ...
                            id2 = "Midpoint_metastatic_tumor",
                            pval = 0.05,
                            logfc = 0.25,
                            spec = "human")

#Download the ligand_receptor reference
...
fl_object <- find_ligands(sender_receiver_sobj,                    #sender seurat object
